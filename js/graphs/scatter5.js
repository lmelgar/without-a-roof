...
(function() {
      ...
      if(selected == 'All'){
        ...
        svg.selectAll(".dots")
            ...
            .attr("opacity", function (d) {
              if ((d.stamp_children_rate) && (d.under18bk_perc)) {
                return dotOpacity;
              } else {
                return 0;
              }
    ...
    function drawScatter(year) {
      ...
      .attr("cy", function (d) {
        if (!isNaN(d.under18bk_perc)) {
          return yScale(+d.under18bk_perc);
        }
      })
      .attr("r", function (d) {
  ...
  function redraw(year) {
    ...
    circles.attr("fill", function (d) {
      if (!(d.under18bk_perc) || !(d.stamp_children_rate)) {
        return "rgba(0, 0, 0, 0)";
      } else {
        if (d.selection == "Top") {
          return "rgb(184,92,87)";
  ...
  function mouseoverFunc(d) {
    ...
    "<br>Children receiving food stamps (per every 1,000 children): " + "<em>" + d3.format("")(d.stamp_children_rate) + "</em>" + "</p>");
