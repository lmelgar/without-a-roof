...
console.log("NO FLORIDA", dataflor);
    ...
    function drawAxes() {
      ...
      .text("Estudiantes que obtuvieron 3 o más en matemáticas");
      ...
      .style("text-anchor", "end")
      .attr("class", "label_sca")
      .text("Estudiantes que recibieron sellos de comida");
    }
    ...
    function drawScatter(year) {
      ...
      circles.attr("cx", function (d) {
        if (!isNaN(d.level3highermath_perc)) {
          return xScale(+d.level3highermath_perc);
        }
      })
      .attr("cy", function (d) {
  ...
  function redraw(year) {
    ...
    d3.select("line#ymean7").transition()
      .attr("y1", yScale(ymean))
      .attr("y2", yScale(ymean))
      .duration(100)
      .ease("quad");
  ...
  function mouseoverFunc(d) {
    ...
    "<br>Estudiantes que obtuvieron 3 o más en matemáticas: " + "<em>" + d.level3highermath_perc + "%</em>" +
